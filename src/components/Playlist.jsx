...
const Playlist = () => {
    ...
    return (
        <section className="min-h-screen bg-background-dark text-white pt-32 pb-40 px-6 md:px-24">
            <motion.div
            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-20">
                    ...
                    <div className="relative w-full md:w-80">
                        ...
                        <input
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-full py-4 pl-12 pr-6 text-sm focus:border-accent-primary outline-none transition-colors"
                        />
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                    <div className="hidden md:grid grid-cols-[1fr_2fr_1fr_1fr] px-8 py-4 text-[10px] uppercase tracking-[0.3em] font-bold text-white/20 border-b border-white/5">
                        <span>#</span>
                        <span>Title</span>
                        <span>Category</span>
                    ...
                    {filteredSongs.map((song, i) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`group grid grid-cols-[50px_1fr_100px_100px] md:grid-cols-[1fr_2fr_1fr_1fr] items-center px-8 py-6 rounded-2xl cursor-pointer transition-all ${isCurrent ? 'bg-accent-primary text-background-dark' : 'hover:bg-white/5'}`}
                            >
                                ...
                                <div className="text-right">
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center ml-auto transition-all ${isCurrent ? 'bg-background-dark text-white' : 'bg-white/10 group-hover:bg-accent-primary group-hover:text-background-dark'}`}>
